<?php if($this->session->userdata('hak_akses')==='admin' || $this->session->userdata('hak_akses')==='Kurikulum' || $this->session->userdata('hak_akses')==='Kepsek' ):?> 
...
<?php elseif($this->session->userdata('hak_akses')==='Guru'):?> 
	...
	<?php elseif($this->session->userdata('hak_akses')==='siswa'):?> 
		...
		<?php elseif($this->session->userdata('hak_akses')==='Walas'):?> 
			<div class="sidebar sidebar-style-2">			
				<div class="sidebar-wrapper scrollbar scrollbar-inner">
					<div class="sidebar-content">
						<div class="user">
