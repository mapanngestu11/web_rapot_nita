					...
					<div class="modal-dialog modal-lg" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								<form action="<?php echo base_url('Homepage/Kehadiran/update') ?>" method="POST">
									...
									<div class="row">
										<div class="col-sm-12">
											<div class="form-group form-group-default">
												<label>Izin</label>
												<input type="text" name="izin" class="form-control">
											</div>
										</div>
									</div>
									<div class="row">
								...
								<form action="<?php echo base_url('Homepage/Kehadiran/update') ?>" method="POST">
									...
									<div class="row">
										<div class="col-sm-12">
											<div class="form-group form-group-default">
												<label>Sakit</label>
												<input type="text" name="predikat" class="form-control" value="<?php echo $sakit;?>" readonly>
											</div>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-sm-12">
											<div class="form-group form-group-default">
												<label>Izin</label>
												<input type="text" name="predikat" class="form-control" value="<?php echo $izin;?>" readonly>
											</div>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-sm-12">
											<div class="form-group form-group-default">
												<label>Alpa</label>
												<input type="text" name="predikat" class="form-control" value="<?php echo $alpa;?>" readonly>
											</div>
										</div>
									</div>
