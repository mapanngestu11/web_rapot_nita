														...
														<div class="row">
															<div class="col-sm-12">
																<div class="form-group form-group-default">
																	<label>Nisn</label>
																	<input id="addName" type="text" class="form-control" placeholder="Nisn" required="">
																</div>
															</div>
															<div class="col-md-6 pr-0">
																<div class="form-group form-group-default">
																	<label>Nama Siswa</label>
																	<input id="addPosition" type="text" class="form-control" placeholder="Nama Siswa">
																</div>
															</div>
															<div class="col-md-6">
																<div class="form-group form-group-default">
																	<label>Kelas</label>
																	<input id="addOffice" type="text" class="form-control" placeholder="Kelas">
																</div>
															</div>
															<div class="col-sm-6">
																<div class="form-group form-group-default">
																	<label>Tempat Lahir</label>
																	<input id="addPosition" type="text" class="form-control" placeholder="Tempat Lahir">
																</div>
																<div class="form-group form-group-default">
																	<label>Tanggal Lahir</label>
																	<input id="addPosition" type="date" class="form-control" placeholder="Nama Siswa">
																</div>
															</div>
														</div>
													</form>
